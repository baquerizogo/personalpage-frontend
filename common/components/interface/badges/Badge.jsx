const Badge = ({children, className, type, size}) => {
    ...
    const config = {
        ...
        primary: 'bg-primary-100/70 dark:bg-primary-700/50 text-primary-700 dark:text-primary-300',
        secondary: 'bg-lowContrast/70 dark:bg-secondary-800/20 shadow-sm backdrop-blur-md text-secondary-600 dark:text-secondary-300',
    }

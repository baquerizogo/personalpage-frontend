...
const Header = () => {
    return (
        <header className="fixed top-0 left-0 right-0 z-40 lg:grid-layout">
            <nav className="relative px-5 lg:px-0 py-2 bg-background/90 backdrop-blur-md flex justify-between items-center rounded-b-lg lg:col-start-2 lg:col-end-12">
                <div>
